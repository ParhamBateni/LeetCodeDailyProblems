...
class Solution1310 : public ::testing::Test {
public:
...
TEST(Solution1310, T1) {
    ...
    ASSERT_TRUE(expected == Solution1310::xorQueries(arr, queries));
}

TEST(Solution1310, T2) {
    vector<int> arr{4, 8, 2, 10};
    vector<vector<int>> queries{{2, 3},
                                {1, 3},
                                {0, 0},
                                {0, 3}};
    vector<int> expected{8, 0, 4, 4};
    ASSERT_TRUE(expected == Solution1310::xorQueries(arr, queries));
}